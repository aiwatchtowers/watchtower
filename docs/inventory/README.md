...
| Dashboard — **RETIRED 2026-09-14** | [dashboard.md](dashboard.md) | *(tombstone — no live code path; `situations`/`situation_signals` survive as read-only history behind `internal/db/situations.go`'s four remaining readers)* |
