...
- **Transcript** — the full transcript. Recordings with per-utterance segments show it as an utterance list (speaker + timecode per merged utterance) with hover-to-delete and undo; older recordings show flat text.
