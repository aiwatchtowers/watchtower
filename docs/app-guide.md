...
- **Discuss with secretary** — a collapsed section below the member signals, showing a message-count badge once a conversation exists; click to expand a chat. Nothing is generated until you send a message or click **Draft reply** — a one-click request for a ready-to-send reply in your voice, drawing on your secretary brief, communication style profile, the counterparties' people-card notes, and a sample of your own recent messages in the same channels. Every secretary message has a **Copy** button; the app never posts to Slack, so copy the draft and paste it via the Slack links above.
