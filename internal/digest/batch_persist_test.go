...
func TestPersistBatchResults_BareChannelIDMatchesNamespacedEntry(t *testing.T) {
	...
	batch := []batchEntry{
		{channelID: "1:C1", channelName: "general", msgs: []db.Message{{TS: "1000.000100", TSUnix: 1000}}},
		{channelID: "1:C2", channelName: "random", msgs: []db.Message{{TS: "1000.000200", TSUnix: 1000}}},
	}
	...
	agg := &batchAggregator{}
	saved := p.persistBatchResults(batch, results, 900, nil, 0, agg)
...
func TestPersistBatchResults_AmbiguousBareIDAcrossAccountsSkipsBoth(t *testing.T) {
	...
	batch := []batchEntry{
		{channelID: "1:C1", channelName: "acct1-general", msgs: []db.Message{{TS: "1000.000100", TSUnix: 1000}}},
		{channelID: "2:C1", channelName: "acct2-general", msgs: []db.Message{{TS: "1000.000200", TSUnix: 1000}}},
	}
	results := []BatchChannelResult{
		{ChannelID: "C1", Summary: "s1"},
	}
