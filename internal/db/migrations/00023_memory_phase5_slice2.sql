...
-- (Gmail episode extraction, see 00032), and memory_last_interaction_id (5D
-- interaction-ingest floor, see 00032). It advances only behind
...
-- +goose Down
-- Precedent: 00017-00019, 00032's Down drops their ALTER-added columns so a
