...
func TestAllTablesExist(t *testing.T) {
	...
	expectedTables := []string{
		...
		"memory_focus_matches", "memory_step_state",
...
// TestKBFTSTriggersSync pins that kb_chunks writes stay in sync with kb_fts
// via the kb_chunks_ai/ad/au triggers (migration 00072).
