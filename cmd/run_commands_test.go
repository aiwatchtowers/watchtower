...
func TestRunBriefingList_NoUser(t *testing.T) {
	...
	require.ErrorIs(t, runBriefingList(c, nil), db.ErrNoOwner)
}
...
func TestRunDayPlanCheckConflicts_NoUser(t *testing.T) {
	...
	require.ErrorIs(t, runDayPlanCheckConflicts(c, nil), db.ErrNoOwner)
}
...
func TestRunBriefing_NoUser(t *testing.T) {
	...
	require.ErrorIs(t, runBriefing(c, nil), db.ErrNoOwner)
}
