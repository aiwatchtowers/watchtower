...
// WatchtowerKit (shared models + the phone's replica-side mirrors). These type
...
typealias StreamDigest = WatchtowerCore.StreamDigest
typealias StreamTopic = WatchtowerCore.StreamTopic
typealias StreamCandidate = WatchtowerCore.StreamCandidate
