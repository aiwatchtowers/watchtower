...
package enum MeetingNoteQueries {

    // MARK: - Fetch

    package static func fetchForEvent(_ db: Database, eventID: String) throws -> [MeetingNote] {
        try MeetingNote
    ...
    package static func update(_ db: Database, id: Int64, text: String) throws {
        try db.execute(
    ...
    package static func countForEvent(_ db: Database, eventID: String) throws -> Int {
