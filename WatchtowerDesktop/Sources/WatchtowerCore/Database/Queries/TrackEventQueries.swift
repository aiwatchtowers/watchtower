...
package enum TrackEventQueries {

    package static func fetchEvents(_ db: Database, trackId: Int, limit: Int = 100) throws -> [TrackEvent] {
    ...
    package static func unreadCount(_ db: Database, trackId: Int) throws -> Int {
    ...
    package static func sourcePermalink(_ db: Database, sourceType: String, sourceId: String) throws -> String? {
    ...
    package static func fetchForTarget(_ db: Database, targetID: Int, limit: Int = 200) throws -> [TrackEvent] {
        try TrackEvent.fetchAll(db, sql: """
