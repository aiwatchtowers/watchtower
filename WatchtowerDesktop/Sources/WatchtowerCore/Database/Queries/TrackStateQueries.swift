...
package enum TrackStateQueries {
    ...
    package static func fetchByTrackID(_ db: Database, trackID: Int) throws -> [TrackState] {
    ...
    package static func count(_ db: Database, trackID: Int) throws -> Int {
        try Int.fetchOne(
            db,
