...
package enum UserAnalysisQueries {
    ...
    package static func fetchForWindow(
        _ db: Database,
        periodFrom: Double,
        periodTo: Double
    ) throws -> [UserAnalysis] {
    ...
    package static func fetchLatest(_ db: Database) throws -> [UserAnalysis] {
    ...
    package static func fetchByUser(
        _ db: Database,
        userID: String,
        limit: Int = 10
    ) throws -> [UserAnalysis] {
    ...
    package static func countRedFlags(_ db: Database) throws -> Int {
    ...
    package static func fetchPeriodSummary(
        _ db: Database,
        periodFrom: Double,
        periodTo: Double
