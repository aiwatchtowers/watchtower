...
package enum MemoryQueries {
    ...
    /// (they are not nodes).
    package static func fetchNodes(_ db: Database, sort: MemorySort = .recent) throws -> [MemoryNodeListItem] {
    ...
    package static func fetchNode(_ db: Database, id: String) throws -> MemoryNodeListItem? {
    ...
    package static func searchNodes(_ db: Database, query: String, limit: Int = 40) throws -> [MemorySearchHit] {
    ...
    package static func resolveNodeID(_ db: Database, target: String) throws -> String? {
    ...
    package static func fetchAliases(_ db: Database, nodeID: String) throws -> [String] {
        try String.fetchAll(
            db,
    ...
    package static func fetchTitle(_ db: Database, id: String) throws -> String? {
        try String.fetchOne(
            db,
    ...
    package static func fetchBeliefs(_ db: Database) throws -> [MemoryBeliefRow] {
    ...
    package static func fetchTypeCounts(_ db: Database) throws -> [String: Int] {
    ...
    package static func fetchDisputedCount(_ db: Database) throws -> Int {
        try Int.fetchOne(
            db,
            sql: """
