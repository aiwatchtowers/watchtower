...
package enum MemoryMarkdown {

    /// Custom URL scheme carrying wiki-link taps out of rendered markdown.
    package static let linkScheme = "watchtower-memory"
    ...
    package static func splitFrontmatter(_ raw: String) -> (frontmatter: String, body: String) {
        let fence = "---\n"
    ...
    package static func patchImportanceOverride(frontmatter: String, value: Double?) -> String {
    ...
    package static func currentImportanceOverride(frontmatter: String) -> Double? {
        let prefix = "importance_override:"
    ...
    package static func parseWikiLinks(_ body: String) -> [MemoryWikiLink] {
    ...
    package static func convertWikiLinks(
        in body: String,
    ...
    package static func linkURL(for target: String) -> String? {
    ...
    package static func linkTarget(from url: URL) -> String? {
