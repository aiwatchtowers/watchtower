...
package struct JiraAccount: FetchableRecord, Identifiable, Equatable {
    ...
    /// The connecting person's own Atlassian identity (GET /myself, migration
    /// 00071); empty until the connect (or the daemon's lazy fill) records it.
    package let ownerAccountID: String
    package let ownerEmail: String
    package let ownerDisplayName: String
