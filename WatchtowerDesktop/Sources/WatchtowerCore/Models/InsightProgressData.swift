...
package struct InsightProgressData: Codable {
    ...
    package let stepDurationSeconds: Double?
    package let stepInputTokens: Int?
    package let stepOutputTokens: Int?
    package let stepCostUsd: Double?
