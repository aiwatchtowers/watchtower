...
package struct TranscriptUtterance: Codable, Equatable, Sendable, Identifiable {
    package let idx: Int
    ...
    package init(idx: Int, startSec: Double, endSec: Double, speaker: String, text: String, deleted: Bool = false) {
        self.idx = idx
...
package enum TranscriptSegments {
    ...
    package static func render(_ utterances: [TranscriptUtterance]) -> String {
    ...
    package static func encode(_ utterances: [TranscriptUtterance]) -> String? {
    ...
    package static func decode(_ json: String) -> [TranscriptUtterance]? {
