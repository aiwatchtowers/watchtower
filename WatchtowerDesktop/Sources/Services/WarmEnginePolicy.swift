...
struct WarmMeetingWindow: Equatable {
    var hasOngoingMeeting: Bool
    var nextStart: Date?
    ...
    static let noMeetings = Self(hasOngoingMeeting: false, nextStart: nil)
}
...
enum WarmEnginePolicy {
    ...
    static func meetingSoon(window: WarmMeetingWindow, now: Date) -> Bool {
    ...
    static func window(events: [CalendarEvent], now: Date) -> WarmMeetingWindow {
