    ...
    var body: some View {
        ...
        .sheet(isPresented: $showCreateSheet) {
            CreateTargetSheet { newID in
                ...
                // chat — streaming, queued behind an earlier brief, or showing
                // the hand-off failure banner; a ⌘Enter silent create stays
                // put. The brief center already carries this target's phase
                // before onCreated fires.
                switch appState.targetBriefCenter.phase(for: newID) {
